...
;
; Bank 2:
; Map data represents tiles 7 pixels across (20 tiles)
; and 8 pixels high (24 tiles tall)
; planning on having zig aag tire treads
; colliding with a tread will slow you down, maybe pull you along
; gaps in treads allow you to get into other columns quickly
; possible that it will always be rolling and can sweep you away
; holes need to be "shot" and if you run into them you get dragged away and go around.
; tire deflates when there are holes
; 
